...
type Configuration struct {
	...
	ConfluentStreamGovernanceApiUrl      string `env:"CG_CONFLUENT_STREAM_GOVERNANCE_API_URL"`
	ConfluentStreamGovernanceApiUsername string `env:"CG_CONFLUENT_STREAM_GOVERNANCE_API_USERNAME"`
	ConfluentStreamGovernanceApiPassword string `env:"CG_CONFLUENT_STREAM_GOVERNANCE_API_PASSWORD"`
}
...
func (c *Configuration) CreateCloudApiAccess() confluent.CloudApiAccess {
	return confluent.CloudApiAccess{
		...
		StreamGovernanceApiEndpoint: c.ConfluentStreamGovernanceApiUrl,
		StreamGovernanceApiUsername: c.ConfluentStreamGovernanceApiUsername,
		StreamGovernanceApiPassword: c.ConfluentStreamGovernanceApiPassword,
	}
}

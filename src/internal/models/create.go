...
func NewCreateProcess(capabilityId CapabilityId, clusterId ClusterId, topicId string, topic TopicDescription, hasServiceAccount bool, hasClusterAccess bool) *CreateProcess {

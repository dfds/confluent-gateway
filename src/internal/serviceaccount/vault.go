...
type Vault interface {
	...
	QueryApiKey(ctx context.Context, capabilityId models.CapabilityId, clusterId models.ClusterId) (bool, error)
}
...
func (v *vaultService) QueryApiKey(capabilityId models.CapabilityId, clusterAccess *models.ClusterAccess) (bool, error) {
	return v.vault.QueryApiKey(v.context, capabilityId, clusterAccess.ClusterId)
}
